...
type CreateResponse struct {
	LendingBook domain.LendingBooks `json:"lendingbook"`
}
...
func MakeFindEndPoint(s service.Service) endpoint.Endpoint {
	return func(ctx context.Context, request interface{}) (interface{}, error) {
		var lendingbookFind domain.LendingBooks
...
type FindAllResponse struct {
	LendingBooks []domain.LendingBooks `json:"lendingbooks"`
}
...
func MakeDeleteEndpoint(s service.Service) endpoint.Endpoint {
	return func(ctx context.Context, request interface{}) (interface{}, error) {
		var (
			lendingbookFind = domain.LendingBooks{}
